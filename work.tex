...
\title{Resume}
\address{28 The Fenway}{Boston, MA 02215}
\mobile{(617) 682-9735}
...
{
\begin{itemize}
\item Worked directly on the C++ codebase
\item Developed and implemented features that are already available to customers
\end{itemize}
}
